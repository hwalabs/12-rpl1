            ...
            <div class="row justify-content-center">
                <div class="col-sm-8 d-flex justify-content-center">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="w-100">
                                <form action="../../backend/querySql/updateSiswa.php" method="POST">
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-8">
                                            <select
                                                ...
                                                <option value="Teknik Bisnis Sepeda Motor" <?= $data['jurusan'] == 'Teknik Bisnis Sepeda Motor' ? 'selected' : '' ?>>
                                                    Teknik Bisnis Sepeda Motor
                                                </option>
                                                <option value="Agribisnis Tanaman Pangan dan Hortikultura" <?= $data['jurusan'] == 'Agribisnis Tanaman Pangan dan Hortikultura' ? 'selected' : '' ?>>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-primary alig" name="update">
                                            UPDATE
                                        </button>
                                    </div>
                                </form>
